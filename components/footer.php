<footer class="footer">
   <section class="footer-grid">
      ...
      <div class="footer-box">
         ...
         <a href="mailto:support@tonyelectronics.com"><i class="fas fa-envelope"></i> support@tonyelectronics.com</a>
   ...
   <div class="footer-credit">
      <p>&copy; 2026 Tony Electronics — Premium Electronics, Delivered.</p>
   </div>
</footer>
